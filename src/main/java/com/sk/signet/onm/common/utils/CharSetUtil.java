...
public class CharSetUtil {
    ...
    /**  
     * <p>모든 메소드가 static이기 때문에 <code>CharSetUtil</code> 인스탄스는 
     * 일반적으로 필요하지 않음.<br> 
     * 대신 아래와 같이 사용하면 됨.<br> 
     * <code>CharSetUtil.evaluateSet(null)</code>.</p>
     *
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>수행해야 할 <code>CharSet</code> 인스탄스를 얻는다.</p>
     * <p>구문은 아래와 같다.:</p>
     * <ul>
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>지정한 set에 대해서 주어진 문자열의 반복값을 없앤다.</p>
     *
     * @pi2.example .
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>지정한 set에 대해서 주어진 문자열에 존재하는 캐릭터 갯수를 얻는다.</p>
     *
     * @pi2.example .
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>지정한 set에 대해서 주어진 문자열과 일치하는 캐릭터를 얻는다(유지한다).</p>
     *
     * @pi2.example .
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>지정한 set에 대해서 주어진 문자열과 일치하는 캐릭터를 지운다.</p>
     *
     * @pi2.example .
     ...
     *
     * @deprecated 가급적 {@link StringUtil#replaceChars(String, String, String)}를 이용할 것.
     */
    @Deprecated
